...
public class TableMethodsInCourse {
    private WebElement tableElement;
    private WebDriver driver;

    public TableMethodsInCourse(WebElement tableElement, WebDriver driver) {
